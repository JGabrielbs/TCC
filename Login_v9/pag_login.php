...
<body>
	...
	<div class="container-login100" style="background-image: url('Imagens/gradient2.jpg');">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form">
				...
				<div class="wrap-input100 validate-input m-b-20" data-validate="coloque o email">
					<input class="input100" type="text" name="username" placeholder="Seu email">
				...
				<div class="text-center">
					<a href="pag_registration.php" class="txt2 hov1">
						Cadastrar-se
					</a>
				</div>
			</form>
